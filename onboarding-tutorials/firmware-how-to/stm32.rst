...
Currently this is heavily based on Processor board as it's the only board using STM32+FreeRTOS, but much of the info applies to STM32 and FreeRTOS in general too.
